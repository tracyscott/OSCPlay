...
public class IntToBangHandler implements RewriteHandler {
    ...
    public boolean configure(String[] args) {
        if (args.length != 1) {
            throw new IllegalArgumentException("IntToBangHandler requires one argument");
        }
    ...
    public void showPreferences() {
        ...
        stage.setTitle("IntToBang Handler Preferences");
